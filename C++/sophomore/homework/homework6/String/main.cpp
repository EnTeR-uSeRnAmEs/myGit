...
void test01()
{
	cout << "------------- 构造函数的测试 -------------" << endl;
	String S0;
	cout << "1. String S0\n   S0的长度为: " << S0.length() << " , S0的容量为: " << S0.capacity() << endl;
	cout << endl;
	String S1 = "This is a test.";
	cout << "2. String S1 = \"This is a test.\"\n   S1的长度为: " << S1.length() << " , S1的容量为: " << S1.capacity() << endl;
	cout << endl;
	String S2 = S1;
	cout << "3. String S2 = S1\n   S2的长度为: " << S2.length() << " , S2的容量为: " << S2.capacity() << endl;
	cout << endl;
	String S3('c', 10);
	cout << "4. String S3('c', 10)\n   S3的长度为: " << S3.length() << " , S3的容量为: " << S3.capacity() << endl;
	cout << endl;
	String S4(S2, 10, 4);
	cout << S4 << endl;
	cout << "5. String S4(S2, 10, 4)\n   S4的长度为: " << S4.length() << " , S4的容量为: " << S4.capacity() << endl;
	cout << endl;
	String S5("This is a test.", 10);
	cout << S5 << endl;
	cout << "5. String S5(\"This is a test.\", 10)\n   S5的长度为: " << S5.length() << " , S5的容量为: " << S5.capacity() << endl;
	cout << endl;
	cout << "------------- 运算符重载的测试 -------------" << endl;
	cout << "1.\"<<\" 和 \">>\" 重载" << endl;
	cout << "  输入任意字符串到S0(cin >> S0)   ";
	cin >> S0;
	cout << "  S0的输出: " << S0 << "  S0的长度为: " << S0.length() << " ,S0的容量为 : " << S0.capacity() << endl;
	cout << endl;
	cout << "2.\"+\" , \"+=\" 和 \"=\" 重载" << endl;
	...
	cout << endl;
	cout << "2.length()测试" << endl;
	cout << "  S0.length()       输出为:    " << S0.length() << endl;
	cout << "  S4.length()       输出为:    " << S4.length() << endl;
	cout << endl;
	cout << "3.capacity()测试" << endl;
	cout << "  S0.capacity()     输出为:    " << S0.capacity() << endl;
	cout << "  S4.capacity()     输出为:    " << S4.capacity() << endl;
	cout << endl;
	...
	cout << "  S2.substr(100, -1)输出为:    " << S2.substr(100, -1) << endl;
	cout << "  S0 = " << S0 << endl;
	cout << "  S2 = " << S2 << endl;
	cout << endl;
