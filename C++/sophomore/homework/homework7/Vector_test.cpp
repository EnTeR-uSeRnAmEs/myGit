...
void test01() {
	cout << "------------- 构造函数的测试 -------------" << endl;
	Vector<int> vi1;
	cout << "1. Vector<int> vi1        vi1的个数为: " << vi1.getlength() << " , vi1的容量为: " << vi1.getcapacity() << endl;
	Vector<char> vc1(10);
	cout << "2. Vector<char> vc1(10)   vc1的个数为: " << vc1.getlength() << " , vc1的容量为: " << vc1.getcapacity() << endl;
	Vector<char> vc2(vc1);
	cout << "3. Vector<char> vc2(vc1)  vc2的个数为: " << vc2.getlength() << " , vc2的容量为: " << vc2.getcapacity() << endl;
	cout << endl;
	cout << "------------- 运算符重载的测试 -------------" << endl;
	cout << "1.\"<<\" 和 \">>\" 重载" << endl;
	cout << "  (1)输入0-9到vi1   ";
	...
	cout << "   vi1的输出： " << vi1 << "  vi1的个数为: " << vi1.getlength() << " , vi1的容量为 : " << vi1.getcapacity() << endl;
	cout << endl;
	cout << "  (2)输入A-J到vc1   ";
	cin >> vc1;
	/*for (int i = 0; i < 10; i++) {
	...
	cout << "   vc1的输出： " << vc1 << "  vc1的个数为: " << vc1.getlength() << " , vc1的容量为 : " << vc1.getcapacity() << endl;
	cout << endl;
	cout << "2.\"+\" , \"+=\" 和 \"=\" 重载" << endl;
	...
	vi1.push_back(11);
	vc1.push_back('K');
	cout << "   vi1.push_back(11)   输出为：  " << vi1 << "  vi1的个数为: " << vi1.getlength() << " , vi1的容量为 : " << vi1.getcapacity() << endl;
	cout << "   vc1.push_back('K')  输出为：  " << vc1 << "             vc1的个数为: " << vc1.getlength() << " , vc1的容量为 : " << vc1.getcapacity() << endl;
	cout << "\n2.pop_back()测试" << endl;
	vi1.pop_back();
	vc1.pop_back();
	cout << "   vi1.pop_back()      输出为：  " << vi1 << "  vi1的个数为: " << vi1.getlength() << " , vi1的容量为 : " << vi1.getcapacity() << endl;
	cout << "   vc1.pop_back()      输出为：  " << vc1 << "            vc1的个数为: " << vc1.getlength() << " , vc1的容量为 : " << vc1.getcapacity() << endl;
	cout << "\n3.begin() 和 end() 测试" << endl;
	Vector <int> vi6;
	Vector <char> vc5;
	...
	cout << "    vi1.insert(vi1.begin()+1, 8)        输出为：  " << vi1 << "  vi1的个数为: " << vi1.getlength() << " , vi1的容量为 : " << vi1.getcapacity() << endl;
	cout << "    vc1.insert(vc1.begin()+1, 'Z')      输出为：  " << vc1 << "            vc1的个数为: " << vc1.getlength() << " , vc1的容量为 : " << vc1.getcapacity() << endl;
	...
	try {
		...
		e.print();
		cout << "                    vi1的个数为: " << vi1.getlength() << " , vi1的容量为 : " << vi1.getcapacity() << endl;
	}
	...
	try {
		...
		e.print();
		cout << "                    vc1的个数为: " << vc1.getlength() << " , vc1的容量为 : " << vc1.getcapacity() << endl;
	}
	cout << "\n6.erase()测试" << endl;
	vi1.erase(vi1.begin() + 1);
	vc1.erase(vc1.begin() + 1);
	cout << "    vi1.erase(vi1.begin()+1)        输出为：  " << vi1 << "  vi1的个数为: " << vi1.getlength() << " , vi1的容量为 : " << vi1.getcapacity() << endl;
	cout << "    vc1.erase(vc1.begin()+1)        输出为：  " << vc1 << "            vc1的个数为: " << vc1.getlength() << " , vc1的容量为 : " << vc1.getcapacity() << endl;
	...
	cout << "\n8.getlength() 和 getcapacity() 测试" << endl;
	cout << "    vi1的个数为：" << vi1.getlength() << " , vi1的容量为：" << vi1.getcapacity() << endl;
	cout << "    vc1的个数为：" << vc1.getlength() << " , vc1的容量为：" << vc1.getcapacity() << endl;
	cout << "    vi6的个数为：" << vi6.getlength() << "  , vi6的容量为：" << vi6.getcapacity() << endl;
	cout << "\n9.empty() 测试" << endl;
	...
	vi1.clear();
	vc1.clear();
	cout << "    vi1.clear()        vi1：" << vi1 << " vi1的个数为：" << vi1.getlength() << " , vi1的容量为：" << vi1.getcapacity() << endl;
	cout << "    vc1.clear()        vc1：" << vc1 << " vc1的个数为：" << vc1.getlength() << " , vc1的容量为：" << vc1.getcapacity() << endl;
}
